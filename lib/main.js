(function() {
  var CND, LODASH, TEXT, _reverse, add_lineups, after, alert, badge, debug, echo, eventually, every, exclude_long_words, find_longest_word, help, immediately, info, log, max_lc, njs_fs, njs_path, njs_util, permutations, permute, rainbow, report, resolve_letters, rpr, step, suspend, urge, warn, whisper, width, word, words;

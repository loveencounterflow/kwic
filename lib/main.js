(function() {
  var CND, CODEC, TEXT, badge, echo, help, rpr;
  ...
  this._get_weighter = function(alphabet) {
    ...
    switch (type = CND.type_of(alphabet)) {
      ...
      case 'list':
        ...
        R = function(factor) {
          var ref;
          return (ref = alphabet[factor]) != null ? ref : Infinity;
        };
        break;
      default:
  ...
  this.get_permutations = function(factors, weights) {
  ...
  this.permute = function(entry, settings) {
    var alphabet, factorizer, factors, ref, ref1, weights;
    ...
    return this.get_permutations(factors, weights);
  };

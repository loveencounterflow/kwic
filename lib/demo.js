(function() {
  var CND, CODEC, KWIC, LODASH, TEXT, _reverse, add_lineups, alert, alphabet, badge, debug, echo, entries, entry, exclude_long_words, find_longest_word, help, i, info, kwic, len, log, permute, report, rpr, text, unique_words_from_text, urge, warn, whisper;
  ...
  this.index = function(factoentries, factorizer) {
    var entry;
    if (factorizer == null) {
      factorizer = null;
    }
  ...
  add_lineups = function(words, max_lc, width) {
    var chrs, i, idx, infix, j, last_idx, left_padding_width, len, padding_width, permutations, prefix_A, prefix_B, ref, ref1, ref2, right_padding_width, suffix, word, word_idx;

(function() {
  var CND, CODEC, KWIC, LODASH, TEXT, alert, badge, collection, debug, echo, entries, entry, factors, help, i, infix, info, j, k, len, len1, len2, log, permutation, permutations, prefix, r_weights, rpr, suffix, text, unique_words_from_text, urge, warn, weights, whisper;

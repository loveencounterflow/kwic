(function() {
  var CND, CODEC, KWIC, LODASH, TEXT, _reverse, add_lineups, alert, alphabet, badge, collection, debug, echo, entries, entry, exclude_long_words, factorize, factors, find_longest_word, help, i, infix, info, j, k, key, kwic, l, len, len1, len2, len3, lineup, log, permutation, permutations, permute, prefix, r_weights, ref, ref1, report, rpr, s_KWIC, suffix, text, unique_words_from_text, urge, warn, weight_idx, weights, whisper;
  ...
  if (module.parent == null) {
    ...
    for (k = 0, len2 = entries.length; k < len2; k++) {
      ...
      for (l = 0, len3 = permutations.length; l < len3; l++) {
        permutation = permutations[l];

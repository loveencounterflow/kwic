(function() {
  var CND, CODEC, KWIC, LODASH, alert, badge, collection, debug, echo, entries, entry, factors, help, i, infix, info, j, len, len1, log, permutation, permutations, prefix, r_weights, rpr, suffix, text, unique_words_from_text, urge, warn, weights, whisper;

(function() {
  var CND, CODEC, KWIC, LODASH, TEXT, _reverse, add_lineups, alert, alphabet, badge, debug, echo, entries, entry, exclude_long_words, factorize, find_longest_word, help, i, infix, info, j, key, kwic, len, len1, lineup, log, permute, positions, prefix, ref, ref1, report, rpr, suffix, text, unique_words_from_text, urge, warn, weight_idx, weights, whisper;
  ...
  if (module.parent == null) {
    ...
    for (j = 0, len1 = ref.length; j < len1; j++) {
      ref1 = ref[j], key = ref1[0], weight_idx = ref1[1], weights = ref1[2], positions = ref1[3], lineup = ref1[4], entry = ref1[5];
